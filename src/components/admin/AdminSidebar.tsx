...
import { LayoutDashboard, BookOpen, Store, Users, BarChart3, Settings, LogOut, Truck, Lock, X, Cherry, Gift, FileText, Armchair, TrendingUp, CreditCard, Clock, QrCode } from 'lucide-react'
...
export default function AdminSidebar({ usuarioNombre, empresaNombre, slug, modulos, logoUrl }: Props) {
  ...
  const NAV = [
    ...
    { href: `/${slug}/admin/qr`, label: 'QR y accesos', icon: QrCode },
    ...
    <>
      <aside className="w-56 bg-white border-r border-neutral-100 flex flex-col min-h-screen shadow-sm">
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5">
          ...
          {/* Módulo Delivery — bloqueado si no está activo */}
          {!deliveryActivo && (
