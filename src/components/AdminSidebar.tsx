      ...
      <aside className="w-56 bg-white border-r border-neutral-100 flex flex-col min-h-screen shadow-sm">
        <div className="px-5 py-5 border-b border-neutral-100">
          <div className="flex items-center gap-2.5 mb-0.5">
            <img src="/coneos-icon.png" alt="ConeOS" className="w-7 h-7 rounded-lg" />
            <span className="font-black text-neutral-800">Cone<span className="text-[#1A7FE8]">OS</span></span>
          </div>
