    ...
    planes: [
      {
        ...
        precio: '$150.000', detalle: '/ mes por sucursal',
        base: null,
      ...
      },
      {
        ...
        precio: '$250.000', detalle: '/ mes por sucursal',
        base: 'Todo Starter +',
      ...
      },
      {
        ...
        precio: '$350.000', detalle: '/ mes por sucursal',
        base: 'Todo Pro +',
        modulos: ['Facturación electrónica', 'Mercado Pago'],
      },
    ],
    implementacion: 'Implementación desde $350.000 por sucursal (configuración, puesta en marcha, capacitación y acompañamiento inicial).',
    aclaraciones: [
