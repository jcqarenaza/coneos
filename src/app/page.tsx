...
const MODULOS = [
  ...
  { emoji: '💰', color: ROJO, title: 'Caja', desc: 'Todos los pedidos en un solo lugar: medios de pago, comprobantes, resumen del día y control por canal. Y venta directa de mostrador o telefónica, cargada por tu equipo en segundos.' },
  ...
  { emoji: '💳', color: AZUL, title: 'Cobros y cuentas', desc: 'Mercado Pago y transferencias integrados. Conectá una o varias cuentas y elegí a cuál entra la plata de cada canal: kiosco, delivery, mesas, take away o caja.' },
  ...
  { emoji: '📦', color: VERDE, title: 'Control de stock', desc: 'Marcá qué productos son contables y se descuentan solos con cada venta. Al agotarse desaparecen de todos los canales, y vuelven si el pedido se cancela.' },
