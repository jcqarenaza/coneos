    ...
    <div className="min-h-screen bg-white font-sans text-neutral-900">
      ...
      <nav className="border-b border-neutral-100 px-6 md:px-8 py-4 flex items-center justify-between sticky top-0 bg-white/95 backdrop-blur-sm z-50">
        <div className="flex items-center gap-2.5">
          <img src="/aoki-logo-navy.png" alt="Aoki" className="h-6 w-auto" />
          <span className="font-bold text-lg border-l border-neutral-200 pl-2.5">Gastr<span style={{ color: AZUL }}>OS</span></span>
        </div>
      ...
      <section id="rubros" className="px-6 md:px-8 py-20 max-w-4xl mx-auto text-center">
        ...
        <p className="text-neutral-400 text-sm mt-8">GastrOS adapta su catálogo y operación a la forma en que trabaja cada negocio.</p>
      </section>
      ...
      <section className="px-6 md:px-8 py-20 max-w-4xl mx-auto text-center">
        ...
        <p className="text-neutral-500 text-lg mb-10 max-w-2xl mx-auto">GastrOS está preparado para trabajar con múltiples sucursales, manteniendo la operación y la información de cada una organizada.</p>
        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-left">
            <div className="flex items-center gap-2 justify-center md:justify-start mb-1">
              <img src="/aoki-logo-navy.png" alt="Aoki" className="h-5 w-auto" />
