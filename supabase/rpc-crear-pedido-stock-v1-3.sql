-- ============================================================
-- RPC crear_pedido_stock v1.3 — v1.2 + LOG DE MOVIMIENTOS (Stock V1 Real)
...
begin
  ...
  insert into stock_movimientos (empresa_id, sucursal_id, producto_id, delta, motivo, pedido_id)
